...
SWIFT_MODULE_NAMESPACE_PUSH("AirTurn")
@class NSCoder;
@class UIKeyCommand;

/// Class that listens for AirTurn commands.
/// note:
/// The AirTurn must be connected to the device via Bluetooth.
/// <em>Example:</em>
/// \code
...
///
/// \endcode
SWIFT_CLASS("_TtC7AirTurn13AirTurnDriver")
@interface AirTurnDriver : UIView
