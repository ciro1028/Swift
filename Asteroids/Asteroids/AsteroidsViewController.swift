...
class AsteroidsViewController: UIViewController {
    ...
    private struct Constants {
        ...
        static let normalizeDistanceOfShipFromEdge: CGFloat = 0.2
        ...
        static let normalizedAsteroidFieldCenter: [UIInterfaceOrientation:CGPoint] = [
            .portrait : CGPoint(x: 0.5, y: 1.0-Constants.normalizeDistanceOfShipFromEdge),
            .portraitUpsideDown : CGPoint(x: 0.5, y: Constants.normalizeDistanceOfShipFromEdge),
            .landscapeLeft : CGPoint(x: Constants.normalizeDistanceOfShipFromEdge, y: 0.5),
            .landscapeRight : CGPoint(x: 1.0-Constants.normalizeDistanceOfShipFromEdge, y: 0.5),
